...
Hay que
1. Reflotar lo que se hizo en el 2do cuatri 2022, dejarlo andando. **Importante** - entender de qué se trata. Cualquier cosa pueden consultar con sus compañeres que lo desarrollaron, los encuentran en [la página de las cursadas 2022](../cuatrimestres/2022s1.md).
1. Mostrarle al stakeholder (ya les pasaremos el contacto) lo que hay, y plantear siguientes pasos.
1. Organizar tareas necesarias para que se pueda poner operativo. 
