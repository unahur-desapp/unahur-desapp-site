...
- Información comercial: condiciones de pago

#### Destino
- Información que indica el destino del remito. Este debe tener país, provincia y localidad previamente cargados
...
- Tipo de mercadería (categorización general)
...
#### Registro Inicial:
- Validación de número de remito (formato y unicidad). Verificación de campos obligatorios

#### Cambios de Estado:
- Registro de fecha, hora y usuario en cada cambio de estado
- Validaciones específicas para autorización (Se valida mediante mail del cliente)
- Justificación obligatoria para estado "retenido"

#### Integridad de Datos:
- Control de duplicidades. El remito no puede existir en el sistema para el mismo cliente.
...
2. Interfaces de usuario para registro y consulta de remitos
3. Sistema de validaciones básicas y control de estados
4. Motor de búsqueda con todos los filtros especificados
